...
export function getReqUrl(reqUrl, params = {}){
    var paramsStr = '';
...
export function getJson(uri, params = {}) {
    return getReqUrl(baseUrl + uri,params);
}
export function postReqUrl(reqUrl, params = {}){
...
export function postJson(uri, params = {}) {
    return postReqUrl(baseUrl + uri,params);
}